        ...
        <div class="colorlib-table-cell js-fullheight">
          <div class="row no-gutters">
            <div class="col-md-12 text-center">
              ...
              <ul>
                <li><a href="{{URL::asset('index')}}"><span><small>01</small>Home</span></a></li>
                ...
                <li class="active"><a href="{{URL::asset('blog')}}"><span><small>05</small>Blog</span></a></li>
                <li><a href="{{URL::asset('contact')}}"><span><small>06</small>Contact</span></a></li>
              </ul>
            </div>
          </div>
        </div>
	        ...
	        <div class="row">
	          <div class="col-md-4 ftco-animate">
	            <div class="blog-entry">
	              <a href="{{URL::asset('blog-single')}}" class="block-20" style="background-image: url('images/image_1.jpg');">
	              </a>
	          ...
	          <div class="col-md-4 ftco-animate">
	            <div class="blog-entry" data-aos-delay="100">
	              <a href="{{URL::asset('blog-single')}}" class="block-20" style="background-image: url('images/image_2.jpg');">
	              </a>
	              <div class="text p-4">
	                <div class="meta mb-3">
	                  <div><a href="#">July 12, 2018</a></div>
	          ...
	          <div class="col-md-4 ftco-animate">
	            <div class="blog-entry" data-aos-delay="200">
	              <a href="{{URL::asset('blog-single')}}" class="block-20" style="background-image: url('images/image_3.jpg');">
	              </a>
	              <div class="text p-4">
	                <div class="meta mb-3">
	                  <div><a href="#">July 12, 2018</a></div>
	          ...
	          <div class="col-md-4 ftco-animate">
	            <div class="blog-entry">
	              <a href="{{URL::asset('blog-single')}}" class="block-20" style="background-image: url('images/image_4.jpg');">
	              </a>
	              <div class="text p-4 d-block">
	                <div class="meta mb-3">
	                  <div><a href="#">July 12, 2018</a></div>
	          ...
	          <div class="col-md-4 ftco-animate">
	            <div class="blog-entry" data-aos-delay="100">
	              <a href="{{URL::asset('blog-single')}}" class="block-20" style="background-image: url('images/image_5.jpg');">
	              </a>
	              <div class="text p-4">
	                <div class="meta mb-3">
	                  <div><a href="#">July 12, 2018</a></div>
	          ...
	          <div class="col-md-4 ftco-animate">
	            <div class="blog-entry" data-aos-delay="200">
	              <a href="{{URL::asset('blog-single')}}" class="block-20" style="background-image: url('images/image_6.jpg');">
	              </a>
	              <div class="text p-4">
	                <div class="meta mb-3">
	                  <div><a href="#">July 12, 2018</a></div>
