          ...
          <div class="row no-gutters">
            <div class="col-md-12 text-center">
              ...
              <ul>
                ...
                <li><a href="{{URL::asset('contact')}}"><span><small>05</small>Contact</span></a></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section class="home-slider owl-carousel js-fullheight">
          ...
          <div class="container">
            <div class="row slider-text align-items-center text-center justify-content-center" data-scrollax-parent="true">
              <div class="col-md-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                ...
                <h1 class="mb-3" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Diana Melay</h1>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="slider-item js-fullheight">
          ...
          <div class="container">
            <div class="row slider-text align-items-center text-center justify-content-center" data-scrollax-parent="true">
              <div class="col-md-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                <p><a href="#" class="scroll">I'm from Ukraine</a></p>
            ...
            <div class="col-md-6 wrap ftco-animate">
              <div class="about-desc">
                ...
                <div class="p-5">
                  ...
                  <p>Email: <a href="#">info@email.com</a></p>
          ...
          <div class="row">
            <div class="col-md-4 d-flex align-self-stretch ftco-animate">
              <div class="media block-6 services p-3 py-4 d-block text-center">
                ...
                <div class="icon mb-3">
                  <img class="logo-img rounded-circle img-thumbnail" style="width: 100px; height: 100px" src="images/angular.png">
                </div>
                <div class="media-body">
                  <h3 class="heading">AngularJs</h3>
            ...
            <div class="col-md-4 d-flex align-self-stretch ftco-animate">
              <div class="media block-6 services p-3 py-4 d-block text-center">
                ...
                <div class="icon mb-3">
                  <img class="logo-img rounded-circle img-thumbnail" style="width: 100px; height: 100px" src="images/php.png">
                </div>
                <div class="media-body">
            ...
            <div class="col-md-4 d-flex align-self-stretch ftco-animate">
              <div class="media block-6 services p-3 py-4 d-block text-center">
                ...
                <div class="icon mb-3">
                  <img class="logo-img rounded-circle img-thumbnail" style="width: 100px; height: 100px" src="images/CodeIgniter.jpg">
                </div>
                <div class="media-body">
          ...
          <div class="row">
            <div class="col-md-4 d-flex align-self-stretch ftco-animate">
              <div class="media block-6 services p-3 py-4 d-block text-center">
                <!-- <div class="icon mb-3"><span class="icon-layers"></span></div> -->
                <div class="icon mb-3">
                  <img class="logo-img rounded-circle img-thumbnail" style="width: 100px; height: 100px" src="images/bootstrap.png">
                </div>
                <div class="media-body">
            ...
            <div class="col-md-4 d-flex align-self-stretch ftco-animate">
              <div class="media block-6 services p-3 py-4 d-block text-center">
                <!-- <div class="icon mb-3"><span class="icon-gears"></span></div> -->
                <div class="icon mb-3">
                  <img class="logo-img rounded-circle img-thumbnail" style="width: 100px; height: 100px" src="images/css.png">
                </div>
                <div class="media-body">
            ...
            <div class="col-md-4 d-flex align-self-stretch ftco-animate">
              <div class="media block-6 services p-3 py-4 d-block text-center">
                <!-- <div class="icon mb-3"><span class="icon-code"></span></div> -->
                <div class="icon mb-3">
                  <img class="logo-img rounded-circle img-thumbnail" style="width: 100px; height: 100px" src="images/htmls.png">
                </div>
                  <div class="media-body">
            ...
            <div class="col-md-4 d-flex align-self-stretch ftco-animate">
              <div class="media block-6 services p-3 py-4 d-block text-center">
                <!-- <div class="icon mb-3"><span class="icon-layers"></span></div> -->
                <div class="icon mb-3">
                  <img class="logo-img rounded-circle img-thumbnail" style="width: 100px; height: 100px" src="images/javascript.png">
                </div>
                <div class="media-body">
            ...
            <div class="col-md-4 d-flex align-self-stretch ftco-animate">
              <div class="media block-6 services p-3 py-4 d-block text-center">
                <!-- <div class="icon mb-3"><span class="icon-gears"></span></div> -->
                <div class="icon mb-3">
                  <img class="logo-img rounded-circle img-thumbnail" style="width: 100px; height: 100px" src="images/joomla.png">
                </div>
                <div class="media-body">
                  <h3 class="heading">Joomla</h3>
                </div>
              </div>      
            </div>
            <div class="col-md-4 d-flex align-self-stretch ftco-animate">
              <div class="media block-6 services p-3 py-4 d-block text-center">
                <!-- <div class="icon mb-3"><span class="icon-code"></span></div> -->
                <div class="icon mb-3">
                  <img class="logo-img rounded-circle img-thumbnail" style="width: 100px; height: 100px" src="images/jquery.png">
                </div>
                  <div class="media-body">
            ...
            <div class="col-md-4 d-flex align-self-stretch ftco-animate">
              <div class="media block-6 services p-3 py-4 d-block text-center">
                <!-- <div class="icon mb-3"><span class="icon-layers"></span></div> -->
                <div class="icon mb-3">
                  <img class="logo-img rounded-circle img-thumbnail" style="width: 100px; height: 100px" src="images/laravel.png">
                </div>
                <div class="media-body">
            ...
            <div class="col-md-4 d-flex align-self-stretch ftco-animate">
              <div class="media block-6 services p-3 py-4 d-block text-center">
                <!-- <div class="icon mb-3"><span class="icon-gears"></span></div> -->
                <div class="icon mb-3">
                  <img class="logo-img rounded-circle img-thumbnail" style="width: 100px; height: 100px" src="images/nodejs.png">
                </div>
                <div class="media-body">
            ...
            <div class="col-md-4 d-flex align-self-stretch ftco-animate">
              <div class="media block-6 services p-3 py-4 d-block text-center">
                <!-- <div class="icon mb-3"><span class="icon-code"></span></div> -->
                <div class="icon mb-3">
                  <img class="logo-img rounded-circle img-thumbnail" style="width: 100px; height: 100px" src="images/reactjs.png">
                </div>
                  <div class="media-body">
            ...
            <div class="col-md-4 d-flex align-self-stretch ftco-animate">
              <div class="media block-6 services p-3 py-4 d-block text-center">
                <!-- <div class="icon mb-3"><span class="icon-layers"></span></div> -->
                <div class="icon mb-3">
                  <img class="logo-img rounded-circle img-thumbnail" style="width: 100px; height: 100px" src="images/rubyonrails.png">
                </div>
                <div class="media-body">
                  <h3 class="heading">Ruby on Rails</h3>
                  <!-- <h3 class="heading">Mobile App Design</h3>
                  <h3 class="heading">Responsive Design</h3> -->
                </div>
              </div>      
            ...
            <div class="col-md-4 d-flex align-self-stretch ftco-animate">
              <div class="media block-6 services p-3 py-4 d-block text-center">
                <!-- <div class="icon mb-3"><span class="icon-gears"></span></div> -->
                <div class="icon mb-3">
                  <img class="logo-img rounded-circle img-thumbnail" style="width: 100px; height: 100px" src="images/wordpress.png">
                </div>
                <div class="media-body">
      ...
      <section class="ftco-section">
        <div class="container">
          ...
          <div class="block-3 d-md-flex ftco-animate" data-scrollax-parent="true">
            <a href="#" class="image d-flex justify-content-center align-items-center" style="background-image: url('images/work-1.jpg'); " data-scrollax=" properties: { translateY: '-30%'}">
          ...
          <div class="block-3 d-md-flex ftco-animate" data-scrollax-parent="true">
            <a href="#" class="image order-2 d-flex justify-content-center align-items-center" style="background-image: url('images/work-2.jpg'); " data-scrollax=" properties: { translateY: '-30%'}">
              <div class="icon d-flex text-center justify-content-center align-items-center">
                <span class="icon-search"></span>
              </div>
            </a>
          ...
          <div class="block-3 d-md-flex ftco-animate" data-scrollax-parent="true">
            <a href="#" class="image d-flex justify-content-center align-items-center" style="background-image: url('images/work-3.jpg'); " data-scrollax=" properties: { translateY: '-30%'}">
              <div class="icon d-flex text-center justify-content-center align-items-center">
                <span class="icon-search"></span>
              </div>
            </a>
          ...
          <div class="block-3 d-md-flex ftco-animate" data-scrollax-parent="true">
            <a href="#" class="image order-2 d-flex justify-content-center align-items-center" style="background-image: url('images/work-4.jpg'); " data-scrollax=" properties: { translateY: '-30%'}">
              <div class="icon d-flex text-center justify-content-center align-items-center">
                <span class="icon-search"></span>
              </div>
            </a>
          ...
          <div class="block-3 d-md-flex ftco-animate" data-scrollax-parent="true">
            <a href="#" class="image d-flex justify-content-center align-items-center" style="background-image: url('images/work-5.jpg'); " data-scrollax=" properties: { translateY: '-30%'}">
              <div class="icon d-flex text-center justify-content-center align-items-center">
                <span class="icon-search"></span>
              </div>
            </a>
          ...
          <div class="block-3 d-md-flex ftco-animate" data-scrollax-parent="true">
            <a href="#" class="image order-2 d-flex justify-content-center align-items-center" style="background-image: url('images/work-6.jpg'); " data-scrollax=" properties: { translateY: '-30%'}">
              <div class="icon d-flex text-center justify-content-center align-items-center">
                <span class="icon-search"></span>
              </div>
            </a>
        ...
        <div class="container">
          ...
          <div class="row d-flex justify-content-end">
            <div class="col-md-5 counter-wrap ftco-animate">
              <div class="block-18">
                <div class="text">
                  <span class="ftco-label">Success Projects</span>
